...
// 聊天客户端程序实现，main用作发送线程，子线程用作接收线程
...
void addfriend(int clientfd, string str)
{
    ...
    if (len == -1)
    {
        cerr << "send addfrieng msg error -> " << buffer << endl;
    }
}
...
void chat(int clientfd, string str)
{
    ...
    if (idx == -1)
    {
        cerr << "chat command input invalid!" << endl;
        return;
    }
...
void creategroup(int clientfd, string str)
{
    ...
    if (idx == -1)
    {
        cerr << "create command input invalid!" << endl;
        return;
    }
...
void groupchat(int clientfd, string str)
{
    ...
    if (idx == -1)
    {
        cerr << "groupchat command input invalid!" << endl;
        return;
    }
